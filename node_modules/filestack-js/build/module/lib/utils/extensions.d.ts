export declare const ExtensionsMap: {
    ...
    'application/font-ttf': string;
    'application/vnd.ms-fontobject': string;
    'application/font-otf': string;
    'text/rtf': string[];
    'text/sgml': string[];
    'text/shex': string[];
    'text/slim': string[];
    ...
    'application/vnd.apple.key': string[];
    ...
    'application/x-msi': string;
    'application/x-ms': string;
    'application/vnd.geo+json': string;
    ...
    'font/opentype': string;
    'application/x-bb-appworld': string;
    'application/x-cd-image': string;
    'application/x-opera-extension': string;
    'application/x-ms-dos-executable': string;
    'text/vnd.rim.location.xloc': string;
    'application/x-desktop': string;
    'application/x-typescript': string;
    'application/x-java-archive': string;
    'application/x-sharedlib': string;
};
